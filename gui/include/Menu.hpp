...
namespace Zappy
{
    ...
    class Menu {
      public:
        ...
        void GameScene(RessourceManager &objectPool, Vector3 position, BoundingBox bounds, Zappy::Server server, Music music);
...
class ConfirmButton {
    public:
    bool createButton(float width, float height, float posX,
