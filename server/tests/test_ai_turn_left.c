...
// clang-format off
static bool ai_turn_left(client_t *cli)
{
...
Test(ai_turn, test_turn_left_north)
{
...
Test(ai_turn, test_turn_left_west)
{
...
Test(ai_turn, test_turn_left_south)
{
...
Test(ai_turn, test_turn_left_east)
{
